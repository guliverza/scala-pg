...
class SequentialDigitsSpec extends AnyFlatSpec with should.Matchers {
  "SequentialDigits" should "build correct list" in {
    sequentialDigits(100, 300) should be(List(123, 234))
    sequentialDigits(1000, 13000) should be(List(1234,2345,3456,4567,5678,6789,12345))
    sequentialDigits(1300, 13000) should be(List(2345,3456,4567,5678,6789,12345))
    sequentialDigits(8511, 23553) should be(List(12345,23456))
    sequentialDigits(10, 1000000000) should be(List(12, 23, 34, 45, 56, 67, 78, 89,
